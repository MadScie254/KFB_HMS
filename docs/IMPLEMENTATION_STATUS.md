...
- ward and theatre issue, departmental custody and return-to-pharmacy movements (`transfer`, `consumption` and `return` movement types are defined but nothing creates them);
- quarantine and disposition of returned or damaged medicine;
